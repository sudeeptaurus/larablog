...
@section('content')
    ...
    <form action="{{route('post.update', [$post->id])}}"
        ...
        <div id="previewBox" style="display: none">
            <img src="{{$post->url}}" alt=""id="previewImg" width="500px" class="img-fluid">
        ...
        @if($post->status == 'publish')
            <button class="btn btn-success rounded" type="submit" value="publish" name="status">Update Post</button>
        @else
